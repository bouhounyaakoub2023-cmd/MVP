...
export default async function Demo() {
  ...
  return <PageFrame><main className="demo-shell section-light">
    ...
    <section className="demo-navigation"><div className="container"><div className="section-head"><div><div className="eyebrow">Explore the demonstration surfaces</div><h2>Follow one operational signal.</h2></div><p>These are four views of the same synthetic plant — not four separate products. The current standard product catalogue contains three solutions.</p></div><div className="demo-module-grid">
